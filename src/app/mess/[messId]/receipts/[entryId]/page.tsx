...
export default async function OwnerReceiptPage({
  ...
  return (
    <div className="print:bg-white">
      ...
      <p className="mt-4 text-center text-sm text-text-muted print:hidden">
        Use your browser’s Print command to save this as PDF or share a paper copy.
      </p>
    </div>
  );
}
