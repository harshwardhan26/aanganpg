          ...
          <div className="flex-1 space-y-4">
            ...
            {!UPLOAD_CONFIGURED ? (
              ...
              <div className="flex flex-wrap gap-3">
                ...
                <label className="inline-flex items-center gap-2 bg-slate-800 hover:bg-slate-700 text-white px-4 py-2 rounded-lg font-medium cursor-pointer transition-colors shadow-sm">
